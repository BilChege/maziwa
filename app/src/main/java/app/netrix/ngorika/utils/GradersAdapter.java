...
public class GradersAdapter extends ArrayAdapter<Grader>
{

    private Activity context;
    ArrayList<Grader> data = null;

    public GradersAdapter(Activity context, int resource, ArrayList<Grader> data)
    {
